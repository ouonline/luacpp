...
static void TestClassProperty() {
    ...
    cout << "in cpp, p1 is [" << p1->x << ", " << p1->y << "], p2 is [" << p2->x
         << ", " << p2->y << "]" << endl;
}
    ...
    auto lclass =
        l.CreateClass<Point>("Point")
            ...
            .DefMember<int>(
                ...
                nullptr)
            // write only
            .DefMember<int>("y", nullptr, [](Point* p, int v) -> void {
                p->y = v;
            });
...
static void TestClassMemberFunction() {
    ...
    l.CreateClass<ClassDemo>("ClassDemo")
        ...
        .DefMember("set", &ClassDemo::Set)
        .DefMember("print", &ClassDemo::Print)
        .DefMember<const char* (ClassDemo::*)(const char*) const>(
            "echo_str", &ClassDemo::Echo) // overloaded function
...
static void TestClassStaticProperty() {
    ...
    cout << "after modification, get st_value = " << ClassDemo::st_value
         << endl;
}
...
static void TestClassStaticPropertyReadWrite() {
    ...
    l.CreateClass<ClassDemo>("ClassDemo")
        .DefStatic<int>("st_value", nullptr, [](int v) -> void {
            ClassDemo::st_value = v;
        });
...
static void TestClassStaticMemberFunction() {
    ...
    bool ok = l.DoString(
        "ClassDemo:s_echo('called by class');"
...
static void TestClassLuaMemberFunction() {
    ...
    bool ok = l.DoString(
        "t = ClassDemo('a', 1); t:print_all_str('3', '5', 'ouonline', '1', "
        "'2')");
    assert(ok);
}
...
static void TestClassMemberInheritance() {
    ...
    ok = l.DoString(
        "d1.m_value = 35142; print('after update, m_value = ', d1.m_value)",
        &errmsg);
    assert(ok);
    assert(errmsg.empty());
...
static void TestClassMemberInheritance3() {
    ...
    ok = l.DoString(
        "d2.m_value = 35142; print('after update, m_value = ', d2.m_value)",
        &errmsg);
    assert(ok);
    assert(errmsg.empty());
